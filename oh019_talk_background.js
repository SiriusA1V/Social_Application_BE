...
async function put_the_file(id, binary, contenttype){
    let params = {
     ACL: "public-read",
     Bucket: "ohaco",
     Key: "src/photo/talk_background/" + id + "_"  + date_str + ".png",
...
async function set_photo_url(id){
    ...
    item.backgrou_url = "url"+id+"_"+date_str + ".png";
    
    params = {
        TableName : "ohaco_talk",
        Item : item
    }
...
async function get_info(talk_id){
    var result;
    var params = {
        TableName : "ohaco_talk",
